...
University of Oklahoma y.mozaffar@ou.edu}} % \date{\today} \date{April 
12, 2020} \maketitle \vfill{} \pagebreak{} 
...
the cost it incurs. \vfill \pagebreak{} \bibliography{references.bib} 
\addcontentsline{toc}{section}{References} \vfill \pagebreak{} 
\clearpage \section*{Figures and Tables} \begin{table}[htp] 
\resizebox{\textwidth}{!}{% \begin{tabular}{@{}|c|c|c|l|l|l|l|@{}} 
...
\caption{Counterfactual Analysis} \label{tab:my-table} \end{table}
\end{document}
